-- CreateEnum
CREATE TYPE "Role" AS ENUM ('ADMIN', 'STAFF', 'AGENCY', 'CUSTOMER');
...
CREATE TABLE "TimeSlotQuota" (
    ...
    CONSTRAINT "TimeSlotQuota_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "Hotel" (
    ...
    "name" TEXT NOT NULL,
    "address" TEXT,
    "distanceToMarina" DOUBLE PRECISION,
...
-- CreateIndex
CREATE UNIQUE INDEX "TimeSlotQuota_dayOfWeek_startTime_key" ON "TimeSlotQuota"("dayOfWeek", "startTime");
...
-- AddForeignKey
ALTER TABLE "Appointment" ADD CONSTRAINT "Appointment_agencyId_fkey" FOREIGN KEY ("agencyId") REFERENCES "Agency"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Appointment" ADD CONSTRAINT "Appointment_hotelId_fkey" FOREIGN KEY ("hotelId") REFERENCES "Hotel"("id") ON DELETE SET NULL ON UPDATE CASCADE;
